...
<html>
	<head>
	<meta charset="UTF-8">
	<title>${sessionScope.loginCompany.companyName} 계정 삭제 확인</title>
	<style>
		@import url('https://fonts.googleapis.com/css?family=Raleway:400,700');
		* { box-sizing: border-box; margin: 0; padding: 0; font-family: Raleway, sans-serif; }
		.div-cont { background: linear-gradient(90deg, #C7C5F4, #776BCC); width: 60%; margin: 5%; }
		...
		.login__submit:active, .login__submit:focus, .login__submit:hover { border-color: #6A679E; outline: none; }
	...
	<body>
						...
						<div class="screen">
							<div class="screen__content">
								<form action="delete.cp" method="post" class="login">
									...
									<div class="login__field">
										<i class="login__icon fas fa-eye" onclick="onShow();"></i>
									</div>
									<button type="submit" class="button login__submit">
										<span class="button__text">삭제하기</span>
		...
		<script>
			function onShow() {
				if($(".login__input").prop("type") == 'password') { $(".login__input").prop("type", "text"); }
				else { $(".login__input").prop("type", "password"); }
			}
		</script>
	</body>
</html>